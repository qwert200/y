...
@app.on_message(filters.command("eval") & filters.command("OWNER_ID") & ~filters.forwarded & ~filters.via_bot)
...
@app.on_message(filters.command("sh") & filters.command("OWNER_ID") & ~filters.forwarded & ~filters.via_bot)
